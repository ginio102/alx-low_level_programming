...
/* #endif MAIN_H */
/**
 * check_elf - if file is ELF file
 * @e_ident: pointer t ELF magic numbers
...
/**
 * print_magic - magic numbers of ELF header
...
/**
 *  * print_version - version of ELF header
 *   * @e_ident: pointer to ELF files
 *    */
void print_version(unsigned char *e_ident)
{
...
/**
 * print_osabi - OS/ABI of ELF header.
 * @e_ident: pointer to ELF OS/ABI files
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI: ");
 ...
 * Return: 0
 * Description: not an ELF File or failure - exit code 98
 */
